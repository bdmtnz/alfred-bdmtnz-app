...
const DetailTimezoneTab: React.FC<DetailTimezoneTabProps> = ({ iataCode, icaoCode, country, cityIata, phone }) => {
    return (
        <div>
            <div className="flex items-center mb-10">
                <InformationCircleIcon className="scale-80 ml-[-10px]"/>
                <h2 className="ml-2 text-3xl font-(family-name:--font-jumbo) font-bold bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent">Información Timezone</h2>
            </div>
